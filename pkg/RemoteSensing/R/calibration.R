...
if (sensor == "MSS" ) {
	...
	if (chk) {
		if (spacecraft %in% c("Landsat1", "Landsat2", "Landsat3") & acquisition_date < as.Date("02/01/1979","%m/%d/%Y")) qcalmax <- c(127, 127, 127, 63)
		else if (spacecraft == "Landsat4" & prod_creation_date < as.Date("10/22/1982", "%m/%d/%Y")) qcalmax <- c(127, 127, 127, 63)
